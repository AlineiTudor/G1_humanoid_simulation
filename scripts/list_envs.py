...
All the environments are registered in the `gelsight_tactile_sensors` extension. They start
...
import gelsight_tactile_sensors.tasks  # noqa: F401


def main():
    """Print all environments registered in `gelsight_tactile_sensors` extension."""
